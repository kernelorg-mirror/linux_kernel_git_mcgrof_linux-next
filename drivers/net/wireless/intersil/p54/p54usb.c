...
static void p54u_load_firmware_cb(const struct driver_data *firmware,
				  void *context)
{
			      ...
			      struct usb_interface *intf)
{
	...
	const struct driver_data_req_params req_params = {
		DRIVER_DATA_KEEP_ASYNC(p54u_load_firmware_cb, priv),
	};
	...
	usb_get_dev(udev);
	err = driver_data_request_async(p54u_fwlist[i].fw, &req_params,
