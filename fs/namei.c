...
static int sysctl_protected_symlinks __read_mostly = 0;
static int sysctl_protected_hardlinks __read_mostly = 0;
...
{
	register_sysctl_init("fs", namei_sysctls, "namei");
	return 0;
}
early_initcall(init_fs_namei_sysctls);
