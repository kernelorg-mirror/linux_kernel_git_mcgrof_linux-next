 ...
 *
 * Context: Can only be called after sysctl base path has been registered
 *          It is recommended to call this interface in core_initcall() and
 *          later initcall(), not in early_initcall() and earlier stages.
 */
