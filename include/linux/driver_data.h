...
union driver_data_cbs {
	struct {
		int __must_check (*found_cb)(void *,
					     const struct driver_data *);
		void *found_ctx;
	...
	struct {
		void (*found_cb)(const struct driver_data *, void *);
		void *found_ctx;
...
int driver_data_sync_opt_call_cb(const struct driver_data_req_params *params)
{
	...
	if (!driver_data_sync_opt_cb(params))
		return 0;
	return driver_data_sync_opt_cb(params)(driver_data_sync_opt_ctx(params));
}
