...
/**
 * LINKTABLE_INIT_WEAK - Constructs a weak linker table entry for init
 *
 * @name: linker table name
 * @level: order level
 *
 * Constructs a weak linker table which will need at init.
 */
 ...
 * @level: order level
 *
 * Declares a linker table entry which we will use during init.
 */
 ...
 * @name: table name
 *
 * Declares a linker table entry to be used on init.
 */
...
/**
 * DEFINE_LINKTABLE_INIT - Defines an init time linker table
 *
 * @type: data type
 * @name: table name
 *
